...
namespace Procedurality
{
	public class Mountain 
	{
        ...
        public Mountain(int H,int W, int base_freq, float pers, long seed, int x_o=0, int y_o=0)
        {
            this.Gen(H, W, base_freq, pers, seed,x_o,y_o);
        }
		public Mountain(int size, int base_freq, float pers, long seed,int x_o=0,int y_o=0) 
		{
			this.Gen(size,size,base_freq,pers,seed,x_o,y_o);
		}
